...
\begin{tabular}{ll}
    {\large\textcolor{gray}{\faEnvelope}} &| 
        \href{mailto:nicklas.stockton@google.com}{nicklas.stockton@google.com}\\
  % Phone Number
    {\large\textcolor{gray}{\hspace{3pt}\faMobile}} &| 719.648.3545\\
    {\large\textcolor{gray}{\faPhone}} &| 513.881.3243\\
  % LinkedIn Profile
...
%------------------------------------------------
    ...
    \runsubsection{Database Developer - Rust (Contract)}
    ...
    \runsubsection{Qt GUI Developer - C++ (Contract)}
