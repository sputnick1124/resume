...
%------------------------------------------------
    ...
    \descript{Principal FTL Engineeering and Science (Software)}
    % \begin{compactitem}
    \vspace{1em}
    ...
    \location{2023\textendash Present\hfill{}Boulder, CO}
    %{}
    \begin{compactitem}
    ...
    \location{2022\textendash 2023\hfill{}Annapolis, MD}
    %{}
    \begin{compactitem}
    ...
    % \location{Feb\textendash{}Apr 2020\hfill{}Remote}
    % %{}
    % \begin{compactitem}
    ...
    % \location{Feb\textendash{}Jul 2019\hfill{}Cincinnati, OH}
    % %{}
    % \begin{compactitem}
    %     \item Developed custom plugin for video streaming service to simplify user experience
    %     \item Integrated plugin tightly with main application framework (OBS Studio), contributing features back into
    %         community project where feasible
    %     % \item Contributed back to community when feasible
    %     \item Simplified project architecture using open-source libraries
    % \end{compactitem}
    % %}
    % \experiencespace
    %
    ...
    % \subsection{Engineering and Scientific Innovations, Inc. \hfill Cincinnati, OH}
...
%                \item Dean's list \textemdash\ 2013\textendash Present
    ...
    \vspace*{2ex}
    \runsubsection{AUVSI-SUAS Competition Member \textemdash\  Association for Unmanned Vehicle Systems International}
    \descript{}
    \location{2017}
    \begin{compactitem}
